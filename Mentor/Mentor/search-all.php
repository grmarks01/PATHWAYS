...
$sql .= "FROM pathways_opportunities po WHERE 1=1";
...
if (!empty($search_keyword)) {
    $sql .= " AND (po.program_name LIKE ? OR po.notes LIKE ? OR po.field LIKE ? OR po.eligibility LIKE ?)";
...
$count_sql = "SELECT COUNT(*) as total FROM pathways_opportunities po WHERE 1=1";
$count_params = [];
$count_types = "";

if (!empty($search_keyword)) {
    $count_sql .= " AND (po.program_name LIKE ? OR po.notes LIKE ? OR po.field LIKE ? OR po.eligibility LIKE ?)";
    $keyword_param = "%$search_keyword%";
...
$categories_query = "SELECT DISTINCT category FROM pathways_opportunities WHERE category IS NOT NULL ORDER BY category";
...
<head>
  ...
  <title>Search All Opportunities - Pathways</title>
  ...
  <section class="search-section">
    <div class="container">
      ...
      <div class="search-header" data-aos="fade-down">
        <h1><i class="bi bi-search"></i> Search All Opportunities</h1>
        <p>Explore hundreds of opportunities across the United States</p>
      </div>
        ...
        <form method="GET" action="">
          <div class="filter-row">
            <div class="form-group">
              ...
              <input type="text" id="keyword" name="keyword" placeholder="Search by program name, field, or description..." value="<?php echo htmlspecialchars($search_keyword); ?>">
            </div>
          ...
          <div style="margin-top: 15px;">
            <a href="search-all.php" class="btn-clear">
      ...
      <div class="results-info">
        <div>
          <strong><?php echo $total_results; ?></strong> opportunities found
